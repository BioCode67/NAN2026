...
export const MOVE_TRAITS = {
  plain: {
    name: '표준',
    icon: '🚶',
    desc: '공중 재주가 없는 대신 지상에서 강공격을 남보다 빨리 모은다 — 기본기로 이긴다',
    /**
  ...
  glide: {
    ...
    icon: '🪂',
    desc:
      '떨어질 때 점프를 누르고 있으면 천천히 내려온다 · 활공 중 공격하면 그대로 내리꽂는다',
  ...
  plunge: {
    name: '급강하',
    icon: '🪨',
    desc: '무겁게 떨어지고 착지 순간 발밑에 충격이 퍼진다 — 위에서 내리누른다',
    /** 하강 가속 배율 */
    fallMul: 1.5,
    /** 착지 충격이 터지는 최소 낙하 속도 */
    slamAt: 900,
  ...
  wallkick: {
    name: '벽 차기',
    icon: '🧱',
    desc: '무대 밖으로 밀려도 벽을 한 번 차고 돌아온다 · 돌아오며 내는 첫 방이 세진다',
    /** 벽을 찰 때 안쪽으로 밀어내는 속도 */
    kickX: 520,
    kickY: -620,
    ...
    /** 그 한 방의 피해·넉백 배율 */
    boostMul: 1.45,
    only: '무대 밖으로 밀리면 벽을 한 번 찬다 — 돌아오며 내는 첫 한 방이 세진다',
  },
  drift: {
    name: '표류',
    icon: '🌀',
    desc:
      '공중 관성이 오래 남아 미끄러지듯 흐른다 · 자원 없이 공중 대시 (한 체공에 한 번)',
    /** 공중 조작이 속도를 바꾸는 정도 (1 = 지상과 같음) */
    control: 0.45,
    /** 공중 관성 유지 — 매 프레임 남는 비율 */
    keep: 0.995,
    only: '공중에서 AA / DD → 자원 없이 공중 대시 (한 체공에 한 번)',
  },
} as const;
